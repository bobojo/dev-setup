...
open "${HOME}/init/Monokai.itermcolors"
...
# @TODO: Find a way to sync all this over Dropbox
...
###############################################################################
# Miscellaneous additional tools/tweaks                                       #
###############################################################################
# block malware/ads at a hosts level
